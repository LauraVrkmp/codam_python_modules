...
#  Updated: 2026/01/28 06:56:28 by laveerka        ###   ########.fr        #
#                                                                           #
# ************************************************************************* #
...
def garden_types():
    ...
    print(f"{sunflower.name} ({sunflower.get_type()}): {sunflower.height}cm, "
          "{sunflower.days} days, {sunflower.color} color")
    rose.bloom()
    print()
    ...
    print(f"{birch.name} ({birch.get_type()}): {birch.height}cm, {birch.days} "
          "days, {birch.trunk_diameter}cm diameter")
    print()
    ...
    print(f"{sprout.name} ({sprout.get_type()}): {sprout.height}cm, "
          "{sprout.days} days, {sprout.havest_season} havest")
